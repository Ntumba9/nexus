...
5. **Integration tests are deterministic or they are bugs.** Three sources of intermittent failure were found and fixed, and the rules are recorded here so they are not reintroduced:
