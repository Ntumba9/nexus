...
| `REGISTRATION_ENABLED`                                                            | api, web     | `true` (default) or `false`. `false` closes sign-up: the API answers 403 `REGISTRATION_DISABLED` and the web app hides the links. Existing accounts keep working. Set it on both                                                                                                                                                                                                                                                    |
| `DEMO_LOGIN_EMAIL`, `DEMO_LOGIN_PASSWORD`                                         | web          | optional; shows a login on the sign-in page for a public demo. Use only a read-only account: every visitor sees the password                                                                                                                                                                                                                                                                                                        |
...
[api](docs/api.md) · [ai](docs/ai.md) · [deployment](docs/deployment.md) · [hosted demo](docs/hosted-demo.md) · [decisions](docs/decisions/)
