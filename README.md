...
> **Status: Phase 8 complete (knowledge base and search).** Accounts, organizations, RBAC, projects, services,
...
> Playwright end-to-end). AI investigation is **not built yet**; see the [roadmap](#roadmap). Sections describing those features are the target design.
